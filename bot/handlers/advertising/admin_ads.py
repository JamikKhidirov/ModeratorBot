...
from bot.database.requests import get_pending_ads, update_ad_status, get_user, get_chat, add_balance
...
@router.callback_query(F.data == "admin_ads_list", IsAdminFilter())
...
@router.callback_query(F.data.startswith("ad_view:"), IsAdminFilter())
...
@router.callback_query(F.data.startswith("ad_approve:"), IsAdminFilter())
...
@router.callback_query(F.data.startswith("ad_reject:"), IsAdminFilter())
